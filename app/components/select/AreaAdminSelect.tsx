...
interface AreaAdminSelectProps {
  id: string;
...
const AreaAdminSelect: React.FC<AreaAdminSelectProps> = ({
  ...
  return (
    <div className="relative w-full">
      <button
        type="button"
        className="relative w-full cursor-default rounded-md bg-white py-2 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-blue3 focus:outline-none focus:ring-2 focus:ring-blue3 sm:text-sm sm:leading-6 disabled:opacity-70 disabled:cursor-not-allowed"
...
export default AreaAdminSelect;
